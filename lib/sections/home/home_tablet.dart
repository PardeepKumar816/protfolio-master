              ...
              return SizedBox(
                ...
                child: Column(
                  children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Row(children: [
                              ...
                              SizedBox(width: getDeviceSize(context).width*0.03,),
                    ...
                    if(getDeviceSize(context).width > 767)
                      SizedBox(height: getDeviceSize(context).height /10,),
                    Row(
                      children: [
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.symmetric(vertical:getDeviceSize(context).width <= 767 ? getDeviceSize(context).width*0.04 : getDeviceSize(context).width*0.01),
                                child: Row(
                                  children: [
                                    Container(
                              ...
                              Padding(
                                padding:  EdgeInsets.only(left: getDeviceSize(context).width*0.01,top:getDeviceSize(context).width <= 767 ? getDeviceSize(context).width*0 : getDeviceSize(context).width*0.015),
                                child: getDeviceSize(context).width <= 767 && getDeviceSize(context).height < 1000 ?
                                Row(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Column(
                                    ...
                                    Stack(
                                      children: [
                                        Container(
                                          width: getDeviceSize(context).width * 0.28,
                                          height: getDeviceSize(context).height * 0.28,
                                          decoration: BoxDecoration(
                                              shape: BoxShape.circle,
                                        ...
                                        Align(
                                            alignment: Alignment.center,
                                            child: Image.asset("images/pardeep.png",width: getDeviceSize(context).width*0.25,height: getDeviceSize(context).width*0.25,))
                                      ],
                                    ),
                                  ],
                                ) :
                        ...
                        if(getDeviceSize(context).width > 767 && getDeviceSize(context).height<1000)
                          Expanded(child: Image.asset("images/pardeep.png",width: getDeviceSize(context).width*0.35,height: getDeviceSize(context).width*0.35,))
                      ],),
                    if(getDeviceSize(context).height>1000)
                      SizedBox(width:getDeviceSize(context).width, height: getDeviceSize(context).height/2,child: Image.asset("images/pardeep.png",width: getDeviceSize(context).width*0.35,height: getDeviceSize(context).width*0.35,))
                  ],
                ),
              );
            }
